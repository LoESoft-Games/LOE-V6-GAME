...
public final class BuildEnvironments {
    ...
    public static const LOESOFTPRODUCTION:String = "loesoft";
    public static const LOESOFTTESTING:String = "loesoft-test";
    ...
    private function getEnvironmentFromName(_arg1:String):BuildEnvironment {
        switch (_arg1) {
            ...
            case LOESOFTPRODUCTION:
                return BuildEnvironment.LOEREALM;
            case LOESOFTTESTING:
                return BuildEnvironment.LOEREALMTEST;
        }
        return (null);
    }
