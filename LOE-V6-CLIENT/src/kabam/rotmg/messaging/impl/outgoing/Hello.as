...
public class Hello extends OutgoingMessage {
    ...
    public var internalbuildVersion_:String;
    ...
    public function Hello(_arg1:uint, _arg2:Function) {
        ...
        this.internalbuildVersion_ = new String();
    ...
    override public function writeToOutput(_arg1:IDataOutput):void {
        ...
        _arg1.writeUTF(this.internalbuildVersion_);
    ...
    override public function toString():String {
        return (formatToString("HELLO", "buildVersion_", "gameId_", "guid_", "password_", "secret_", "internalbuildVersion_"));
    }
