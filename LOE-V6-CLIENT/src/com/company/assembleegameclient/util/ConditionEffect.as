...
public class ConditionEffect {
    ...
    public static const PLAYER_TYPE:int = 50;
    ...
    public static const PLAYER_TYPE_BIT:uint = (1 << (PLAYER_TYPE - NEW_CON_THREASHOLD_2));
    ...
    public static var effects_:Vector.<ConditionEffect> =
            new <ConditionEffect>[
                ...
                new ConditionEffect("Player Type", PLAYER_TYPE_BIT, [40], "Player Type", true),
