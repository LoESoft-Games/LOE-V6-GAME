    ...
    partial class BehaviorDb
    {
        private _ Shore = () => Behav()
            .Init("Pirate",
                new State(
                    new Prioritize(
                        new Chase(0.85, range: 1, duration: 5000, coolDown: 0),
                        new Wander(0.4)
                        ),
            ...
            .Init("Piratess",
                new State(
                    new Prioritize(
                        new Chase(1.1, range: 1, duration: 3000, coolDown: 1500),
                        new Wander(0.6)
                        ),
                    new Shoot(3, coolDown: 2500),
            ...
            .Init("Bandit Leader",
                new State(
                    ...
                    new State("meek",
                        ...
                        new StayBack(0.5, 6),
                        new OrderOnce(10, "Bandit Enemy", "escape"),
