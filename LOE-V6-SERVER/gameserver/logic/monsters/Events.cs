            ...
            .Init("Hermit God",
                new State(
                    ...
                    new State("invis",
                        ...
                        new TossObject("Hermit Minion", 9, 0, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 45, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 90, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 135, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 180, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 225, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 270, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 315, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 15, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 30, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 90, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 120, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 150, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 180, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 210, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 240, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 50, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 100, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 150, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 200, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 250, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit Minion", 9, 300, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit God Tentacle", 5, 45, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit God Tentacle", 5, 90, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit God Tentacle", 5, 135, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit God Tentacle", 5, 180, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit God Tentacle", 5, 225, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit God Tentacle", 5, 270, 90000001, coolDownOffset: 0, invisiToss: true),
                        new TossObject("Hermit God Tentacle", 5, 315, 90000001, coolDownOffset: 0, invisiToss: true),
                    ...
                    new State("rage",
                        new SetAltTexture(4),
                        new OrderOnce(20, "Whirlpool", "despawn"),
            ...
            .Init("Hermit God Tentacle",
                new State(
                    new Prioritize(
                        ...
                        new Chase(0.85, range: 1, duration: 2000, coolDown: 0)
                        ),
