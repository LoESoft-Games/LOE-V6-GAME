            ...
            .Init("Deathmage",
                new State(
                    new State("Waiting",
                        ...
                        new OrderOnce(10, "Skeleton", "Protect"),
                        new OrderOnce(10, "Skeleton Swordsman", "Protect"),
                        new OrderOnce(10, "Skeleton Veteran", "Protect"),
                        new OrderOnce(10, "Skeleton Mage", "Protect"),
                    ...
                    new State("Attacking",
                        ...
                        new Prioritize(
                            new StayCloseToSpawn(0.8, 5),
                            new Chase(0.8, range: 8),
                            new Wander(0.4)
                            ),
                        new Shoot(10, 3, 15, predictive: 1),
                        new State("Circling",
                            new Orbit(0.8, 5),
                            new OrderOnce(10, "Skeleton", "Circling"),
                            new OrderOnce(10, "Skeleton Swordsman", "Circling"),
                            new OrderOnce(10, "Skeleton Veteran", "Circling"),
                            new OrderOnce(10, "Skeleton Mage", "Circling"),
                            new TimedTransition(2000, "Engaging")
                            ),
                        new State("Engaging",
                            new OrderOnce(10, "Skeleton", "Engaging"),
                            new OrderOnce(10, "Skeleton Swordsman", "Engaging"),
                            new OrderOnce(10, "Skeleton Veteran", "Engaging"),
                            new OrderOnce(10, "Skeleton Mage", "Engaging"),
