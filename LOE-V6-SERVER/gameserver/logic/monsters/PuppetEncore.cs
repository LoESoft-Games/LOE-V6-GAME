    ...
    partial class BehaviorDb
    {
        ...
        .Init("Encore Huntress Statue",
            new State(
                ...
                new State("2",
                    ...
                    new MoveTo(9.5f, 16.5f, 0.1, true, true, false),
       ...
       .Init("Encore Trickster Statue",
            new State(
                ...
                new State("2",
                    new Flash(0xFFFF00, 2, 5),
                    new MoveTo(16.5f, 16.5f, 0.1, true, true, false),
                    new TimedTransition(2000, "3")
                    ),
                new State("3",
        ...
        .Init("Confuse Puppet Statue",
            new State(
                ...
                new State("2",
                    new Flash(0xFFFF00, 2, 5),
                    new MoveTo(9.5f, 9.5f, 0.1, true, true, false),
                    new TimedTransition(2000, "3")
                    ),
                new State("3",
        ...
        .Init("Bleed Puppet Statue",
            new State(
                ...
                new State("2",
                    new Flash(0xFFFF00, 2, 5),
                    new MoveTo(16.5f, 9.5f, 0.1, true, true, false),
                    new TimedTransition(2000, "3")
                    ),
                new State("3",
        ...
        .Init("Puppet Master v2",
            new State(
                ...
                new State("4",
                    ...
                    new TossObject("Encore Trickster Statue", 8, 45, randomToss: false, coolDown: 3500),
                    new TossObject("Encore Huntress Statue", 8, 135, randomToss: false, coolDown: 3500),
                    new TossObject("Confuse Puppet Statue", 8, 225, randomToss: false, coolDown: 3500),
                    new TossObject("Bleed Puppet Statue", 8, 315, randomToss: false, coolDown: 3500),
