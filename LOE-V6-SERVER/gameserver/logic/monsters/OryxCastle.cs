        ...
        private _ OryxCastle = () => Behav()
            .Init("Oryx Stone Guardian Right",
                new State(
                    ...
                    new State("Order",
                        new OrderOnce(10, "Oryx Stone Guardian Left", "Start"),
            ...
            .Init("Oryx Stone Guardian Left",
                new State(
                    ...
                    new State("Order",
                        new OrderOnce(10, "Oryx Stone Guardian Right", "Start"),
                        new TimedTransition(0, "Start")
                    ),
                    new State("Start",
                        new AddCond(ConditionEffectIndex.Invulnerable),
