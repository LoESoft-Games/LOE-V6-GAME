...
namespace gameserver.logic
{
    partial class BehaviorDb
    {
        ...
        private const float Cooldown = 5000;
            ...
            .Init("vlntns Botany Bella",
                new State(
                    ...
                    new State("Start",
                        ...
                        new Shoot(10, count: 2, shootAngle: 30, angleOffset: (float)45, projectileIndex: 3, coolDown: 1000),
                        new Shoot(10, count: 2, shootAngle: 30, angleOffset: (float)-45, projectileIndex: 3, coolDown: 1000),
                    ...
                    new State("Ring_Attack2",
                        ...
                        new State("Ring",
                            ...
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2, coolDownOffset: 250, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 2, coolDownOffset: 500, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 3, coolDownOffset: 750, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 4, coolDownOffset: 1000, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 5, coolDownOffset: 1250, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 6, coolDownOffset: 1500, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 5, coolDownOffset: 1750, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 4, coolDownOffset: 2000, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 3, coolDownOffset: 2250, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2 * 2, coolDownOffset: 2500, coolDown: 10000),
                            new Shoot(0, count: 6, projectileIndex: 2, fixedAngle: fixedAngle_RingAttack2, coolDownOffset: 2750, coolDown: 10000),
                    ...
                    new State("RAGE_MODE",
                        new State("Everything_is_cool",
                            new State("spawn_minions",
                                ...
                                new TossObject("vlntns Red", range: 9.9, angle: 15, invisiToss: true),
                                new TossObject("vlntns White", range: 6.6, angle: 30, invisiToss: true),
                                new TossObject("vlntns Yellow", range: 3.3, angle: 45, invisiToss: true),
                                new TossObject("vlntns White", range: 9.9, angle: 60, invisiToss: true),
                                new TossObject("vlntns Red", range: 6.6, angle: 75, invisiToss: true),
                                new TossObject("vlntns White", range: 3.3, angle: 90, invisiToss: true),
                                new TossObject("vlntns Yellow", range: 9.9, angle: 105, invisiToss: true),
                                new TossObject("vlntns White", range: 6.6, angle: 120, invisiToss: true),

                                new TossObject("vlntns Red", range: 3.3, angle: 135, invisiToss: true),
                                new TossObject("vlntns White", range: 9.9, angle: 150, invisiToss: true),
                                new TossObject("vlntns Yellow", range: 6.6, angle: 165, invisiToss: true),
                                new TossObject("vlntns White", range: 3.3, angle: 180, invisiToss: true),
                                new TossObject("vlntns Red", range: 9.9, angle: 195, invisiToss: true),
                                new TossObject("vlntns White", range: 6.6, angle: 210, invisiToss: true),
                                new TossObject("vlntns Yellow", range: 3.3, angle: 225, invisiToss: true),
                                new TossObject("vlntns White", range: 9.9, angle: 240, invisiToss: true),

                                new TossObject("vlntns Red", range: 6.6, angle: 255, invisiToss: true),
                                new TossObject("vlntns White", range: 3.3, angle: 270, invisiToss: true),
                                new TossObject("vlntns Yellow", range: 9.9, angle: 285, invisiToss: true),
                                new TossObject("vlntns White", range: 6.6, angle: 300, invisiToss: true),
                                new TossObject("vlntns Red", range: 3.3, angle: 315, invisiToss: true),
                                new TossObject("vlntns White", range: 9.9, angle: 330, invisiToss: true),
                                new TossObject("vlntns Yellow", range: 6.6, angle: 345, invisiToss: true),
                                new TossObject("vlntns White", range: 3.3, angle: 360, invisiToss: true),
