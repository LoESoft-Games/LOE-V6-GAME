            ...
            .Init("shtrs Twilight Archmage",
                new State(
                    ...
                    new State("Spawn Birds",
                        ...
                        new AddCond(ConditionEffectIndex.Invulnerable),
                        new TossObject("shtrs Inferno", 3, 0, 1000000000, 7000, invisiToss: true),
                        new TossObject("shtrs Blizzard", 3, 180, 1000000000, 7000, invisiToss: true),
                        new OrderOnce(15, "shtrs MagiGenerators", "Hide"),
