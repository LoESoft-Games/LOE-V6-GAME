        ...
        private _ Midland = () => Behav()
            ...
            .Init("Orc King",
                new State(
                    ...
                    new Prioritize(
                        new StayAbove(1.4, 60),
                        new Chase(0.6, range: 1, duration: 3000, coolDown: 3000),
                        new Wander(0.6)
                        )
                    ),
            ...
            .Init("Werepanther",
                new State(
                    ...
                    new State("wander",
                        new Prioritize(
                            new Protect(0.65, "Werelion", 11, 7.5, 7.4),
                            new Chase(0.65, range: 5, acquireRange: 10),
                            new Wander(0.65)
                            ),
                    ...
                    new State("jump",
                        new Prioritize(
                            new Protect(0.65, "Werelion", 11, 7.5, 7.4),
                            new Chase(7, range: 1, acquireRange: 6),
                            new Wander(0.55)
                            ),
                        new TimedTransition(200, "attack")
                        ),
                    new State("attack",
                        new Prioritize(
                            new Protect(0.65, "Werelion", 11, 7.5, 7.4),
                            new Chase(0.5, range: 1, acquireRange: 6),
                            new Wander(0.5)
                            ),
            ...
            .Init("Horned Drake",
                new State(
                    ...
                    new State("get_player",
                        new Prioritize(
                            new StayAbove(0.8, 60),
                            new Chase(0.8, range: 2.7, acquireRange: 10, duration: 5000, coolDown: 1800),
                            new Wander(0.8)
                            ),
                        new State("one_shot",
                ...
                new State(
                    ...
                    new State("call_mama",
                        ...
                        new State("cry_for_mama",
                            new StayBack(0.65, 8),
                            new OrderOnce(8, "Horned Drake", "protect_me")
                            )
                        )
                    )
            )
